...
DEFAULT_CURRENCY: str = (
    _normalize_currency(os.getenv("DEFAULT_CURRENCY") or os.getenv("CURRENCY")) or "USD"
)
...
DEFAULT_REMINDER_LEAD_MINUTES: int = _env_int(
    "REMINDER_LEAD_MINUTES", _env_int("DEFAULT_REMINDER_LEAD_MINUTES", 1440)
)
DEFAULT_REMINDER_SAME_DAY_MINUTES: int = _env_int(
    "REMINDER_SAME_DAY_MINUTES", _env_int("SAME_DAY_LEAD_MINUTES", 60)
)
DEFAULT_CANCEL_LOCK_MINUTES: int = _env_int(
    "CANCEL_LOCK_MINUTES", _env_int("CLIENT_CANCEL_LOCK_HOURS", 3) * 60
)
DEFAULT_RESCHEDULE_LOCK_MINUTES: int = _env_int(
    "RESCHEDULE_LOCK_MINUTES", _env_int("CLIENT_RESCHEDULE_LOCK_HOURS", 3) * 60
)
