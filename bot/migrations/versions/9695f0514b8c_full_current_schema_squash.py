...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('reserved', 'pending_payment', 'confirmed', 'paid', 'cancelled', 'done', 'no_show', 'expired', name='booking_status_normalized'), nullable=False),
    ...
    op.create_table('master_client_notes',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('master_id', sa.BigInteger(), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    op.create_table('master_schedule_exceptions',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('master_id', sa.BigInteger(), nullable=True),
    ...
    op.create_index('ix_master_schedule_exceptions_master_id_date', 'master_schedule_exceptions', ['master_id', 'exception_date'], unique=False)
    ...
    op.create_index('ix_master_schedules_master_id_day_of_week', 'master_schedules', ['master_id', 'day_of_week'], unique=False)
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('booking_id', sa.Integer(), nullable=False),
    sa.Column('old_status', sa.Enum('reserved', 'pending_payment', 'confirmed', 'paid', 'cancelled', 'done', 'no_show', 'expired', name='booking_status_normalized'), nullable=True),
    sa.Column('new_status', sa.Enum('reserved', 'pending_payment', 'confirmed', 'paid', 'cancelled', 'done', 'no_show', 'expired', name='booking_status_normalized'), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index('ix_master_schedule_exceptions_master_id_date', table_name='master_schedule_exceptions')
